                        ...
                        lambda day: rx.tooltip(
                            rx.box(
                                ...
                                background_color=rx.color_mode_cond(
                                    light=rx.cond(
                                        day["level"] == 0, light_colors[0],
                                        rx.cond(
                                            day["level"] == 1, light_colors[1],
                                            rx.cond(
                                                day["level"] == 2, light_colors[2],
                                                rx.cond(
                                                    day["level"] == 3, light_colors[3],
                                                    light_colors[4]
                                                )
                                            )
                                        )
                                    ...
                                    dark=rx.cond(
                                        day["level"] == 0, dark_colors[0],
                                        rx.cond(
                                            day["level"] == 1, dark_colors[1],
                                            rx.cond(
                                                day["level"] == 2, dark_colors[2],
                                                rx.cond(
                                                    day["level"] == 3, dark_colors[3],
                                                    dark_colors[4]
                                                )
                                            )
                                        )
                                ...
                                on_click=lambda: TooltipState.open_tooltip(
                                    day["date"]),
                                _hover={
                                    "border": rx.color_mode_cond(
        ...
        *[
            rx.text(
                ...
                color=rx.color_mode_cond(
                    light="rgb(101, 109, 118)",
                    dark="rgb(125, 128, 141)"
                ),
                font_weight="400",
        ...
        for day in range(days_per_week):
            ...
            week_cells.append(
                rx.box(
                    ...
                    height="11px",
                    background_color=rx.color_mode_cond(
                        light=light_colors[level],
                        dark=dark_colors[level]
                    ),
                    border_radius="2px",
                    border=rx.color_mode_cond(
                        light="1px solid rgba(27, 31, 36, 0.06)",
...
def day_labels_static() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.text("Mon", font_size="11px", color=rx.color_mode_cond(
            light="rgb(101, 109, 118)",
            dark="rgb(125, 128, 141)"
        ), width="25px"),
        rx.text("", height="11px", width="25px"),  # Tuesday spacer
        rx.text("Wed", font_size="11px", color=rx.color_mode_cond(
            light="rgb(101, 109, 118)",
            dark="rgb(125, 128, 141)"
        ), width="25px"),
        rx.text("", height="11px", width="25px"),  # Thursday spacer
        rx.text("Fri", font_size="11px", color=rx.color_mode_cond(
            light="rgb(101, 109, 118)",
            dark="rgb(125, 128, 141)"
        ), width="25px"),
...
def contribution_chart() -> rx.Component:
    ...
    return rx.box(
        ...
        rx.cond(
            ...
            rx.flex(
                rx.spinner(size="3"),
                rx.text("Loading contributions...", color=rx.color_mode_cond(
                    light="rgb(101, 109, 118)",
                    dark="rgb(125, 128, 141)"
                )),
                align="center",
